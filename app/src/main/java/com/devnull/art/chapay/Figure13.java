...
public class Figure13
{
    ...
    static void createFigure(Group checkers, int position, int color) {
        ...
        if (color == 0)
        {
            ...
            Vector2 cellCoordinate2=UserInterface.getUI().getGameField().getBoard().getCellCoordinate(position-2,3);
            ...
            cellCoordinate2=UserInterface.getUI().getGameField().getBoard().getCellCoordinate(position-2,4);
            ...
            cellCoordinate2=UserInterface.getUI().getGameField().getBoard().getCellCoordinate(position-2,5);
            actors.get(2).setPosition((cellCoordinate.x+cellCoordinate2.x)/2f,cellCoordinate.y);
            ...
            actors.get(3).setPosition((cellCoordinate.x+cellCoordinate2.x)/2f,cellCoordinate.y);
