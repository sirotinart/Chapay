...
public class Figure16
{
    ...
    static void createFigure(Group checkers, int position, int color) {
        ...
        if (color == 0)
        {
            ...
            cellCoordinate=UserInterface.getUI().getGameField().getBoard().getCellCoordinate(position-1,1);
            ...
            cellCoordinate=UserInterface.getUI().getGameField().getBoard().getCellCoordinate(position-1,7);
